...
<body class="admin-body">
    ...
    <div class="admin-dash-container">
        ...
        <div class="result result-scroll user-table-scroll">
                ...
                <tbody>
                    <?php foreach($user as $users): ?>
                        <tr class="tr-hover">
                            ...
                            <td class='truncate' onclick="this.classList.toggle('expanded')"><?= htmlspecialchars($users['created_at'])?></td>
    ...
    <div class="onclick-container" id="modal">
        ...
        <div class="burger-modal">
            ...
            <div class="burger-modal-anchor">
                <a href="admin-dashboard.php" class="side-anchor side-anchor-first">
                ...
                <a href="admin-user.php" class="side-anchor burger-anchor-active">
